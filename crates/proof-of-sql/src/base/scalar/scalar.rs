    ...
    + TryFrom<BigInt, Error = ScalarConversionError>
{
    ...
    /// Create a scalar field element from its non-Montgomery limb representation.
    fn from_limbs(value: [u64; 4]) -> Self;

    /// Return this scalar field element's non-Montgomery limb representation.
