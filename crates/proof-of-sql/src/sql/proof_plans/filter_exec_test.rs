...
fn we_can_have_projection_as_input_plan_for_filter() {
    ...
    let projection = projection(
        vec![
            AliasedDynProofExpr {
                expr: DynProofExpr::new_column(t.clone(), "a".into(), ColumnType::BigInt),
                alias: "x".into(),
            },
            AliasedDynProofExpr {
            ...
            AliasedDynProofExpr {
                expr: DynProofExpr::new_column(t.clone(), "c".into(), ColumnType::Int128),
                alias: "z".into(),
            },
        ],
        table_exec,
    ...
    let filter_results = vec![
        ...
        AliasedDynProofExpr {
            expr: DynProofExpr::new_column(dummy_table.clone(), "z".into(), ColumnType::Int128),
            alias: "z".into(),
        },
    ];
    // First filter to keep rows where a > 3
    let filter = filter(
        ...
        projection,
        gt(
            DynProofExpr::new_column(dummy_table.clone(), "z".into(), ColumnType::Int128),
