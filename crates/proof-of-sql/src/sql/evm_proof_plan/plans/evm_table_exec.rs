use crate::{
    base::{
        database::{Column, ColumnField, ColumnRef, LiteralValue, TableEvaluation, TableRef},
        map::IndexSet,
        proof::ProofError,
        scalar::Scalar,
        PlaceholderResult,
...
impl StreamlinedProoPlan for EVMTableExec {
...
impl StreamlinedProverEvaluate for EVMTableExec {
