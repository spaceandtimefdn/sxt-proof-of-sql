...
impl EVMScalingCastExpr {
    ...
    pub(crate) fn try_from_proof_expr(
        ...
        Ok(EVMScalingCastExpr {
            ...
            to_type: *expr.to_type(),
            scaling_factor: expr.scaling_factor(),
        })
    }
    ...
    pub(crate) fn try_into_proof_expr(
        ...
        if self.scaling_factor != expr.scaling_factor() {
            return Err(EVMProofPlanError::IncorrectScalingFactor);
        }
        Ok(expr)
    }
}
