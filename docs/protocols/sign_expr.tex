...
2^{255}\leq& l_i&<2^{256}
\end{eqnarray*}
Thus, $d_{255,i} = 1$. So $s_i=1-d_{255,i}$.\\
Negative:
\begin{eqnarray*}
-2^B&\leq& c_i<0\\
0&\leq& l_i<2^{255}
\end{eqnarray*}
Therefore, $d_{255,i}=0$. Ergo, $s_i=1-d_{255,i}$.
...
\begin{eqnarray*}
0\leq&\sum_{j=0}^{254} 2^j\cdot d_{j,i}&<2^{255}\\
0\leq&\sum_{j=0}^{255} 2^j\cdot d_{j,i}&<2^{255}\\
0\leq&c_i + 2^{255}&<2^{255}\\
-2^{255}\leq&c_i&<0
\end{eqnarray*}
So $s_B(c_i)=1=s_i$.\\
...
\begin{eqnarray*}
0\leq&\sum_{j=0}^{254} 2^j\cdot d_{j,i}&<2^{255}\\
0\leq&-2^{255}+\sum_{j=0}^{255} 2^j\cdot d_{j,i}&<2^{255}\\
0\leq&-2^{255}+c_i + 2^{255}&<2^{255}\\
0\leq&c_i&<2^{255}
\end{eqnarray*}
So $s_B(c_i)=0=s_i$.
