...
| Schema integration | `ColumnTypeWithNullability` design (DESIGN_NOTES.md) | DESIGN_NOTES.md | N/A |
...
| Requirement | Implementation | Files | Tests |
|------------|----------------|-------|-------|
| PoC proof test | Nullable column commitment and operations | `nullable_column_proof_test.rs` | All tests in file |
...
| `nullable_column_proof_test` | 7 | ✅ All pass |
...
cargo test -p proof-of-sql --no-default-features --features="arrow cpu-perf test" -- test_nullable_plus_nonnullable_bigint_requirement
```
