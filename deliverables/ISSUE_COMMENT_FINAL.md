...
- **Canonical Null Invariant** - Null positions always contain canonical default (0 for numeric) for proof soundness
- **Null Propagation** - `NULL op X = NULL` via AND-combined validity masks
- **Mixed Nullable/Non-nullable** - Explicit support for `add_nullable_to_nonnullable_bigint()` as required by this issue
