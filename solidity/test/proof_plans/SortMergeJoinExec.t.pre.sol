...
contract SortMergeJoinExecTest is Test {
    ...
    uint256 private constant _FIRST_ROUND_MLE_TOTAL = 14;
    uint256 private constant _FINAL_ROUND_MLE_TOTAL_PART_ONE = 7;
    uint256 private constant _FINAL_ROUND_MLE_TOTAL_PART_TWO = 10;
    ...
    function testSortMergeJoinExec() public pure {
...

        {
            ...
            plan = abi.encodePacked(leftPlan, rightPlan, leftJoinIndices, rightJoinIndices, aliases, hex"abcdef");
        }
