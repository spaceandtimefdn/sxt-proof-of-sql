...
library ProjectionExec {
    ...
    /// ##### Signature
    /// ```yul
    /// projection_exec_evaluate(plan_ptr, builder_ptr, accessor_ptr, one_evals) -> plan_ptr_out, evaluations_ptr, output_chi_eval
    /// ```
    /// ##### Parameters
        ...
        )
    {
        ...
        assembly {
            ...
            function projection_exec_evaluate(plan_ptr, builder_ptr) -> plan_ptr_out, evaluations_ptr, output_chi_eval {
                let input_builder_ptr, input_chi_eval
                plan_ptr, input_builder_ptr, input_chi_eval := proof_plan_evaluate(plan_ptr, builder_ptr)

                plan_ptr_out, evaluations_ptr := get_proof_expr_evaluations(plan_ptr, input_builder_ptr, input_chi_eval)
