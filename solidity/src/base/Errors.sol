...
/// @dev Error code for when bits that shouldn't vary do vary.
uint32 constant ERR_MISMATCHING_COLUMN_AND_CANDIDATE_LENGTHS = 0x32e88b78;
...
library Errors {
    ...
    /// @notice Error thrown when there are a different number of columns and candidates.
    error MismatchingColumnAndCandidateLengths();
