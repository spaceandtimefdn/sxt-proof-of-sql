...
uint32 constant EMPTY_EXEC_VARIANT = 0;
...
uint32 constant PROJECTION_EXEC_VARIANT = 2;
/// @dev Slice variant constant for proof plans
uint32 constant SLICE_EXEC_VARIANT = 3;
/// @dev Union variant constant for proof plans
uint32 constant UNION_EXEC_VARIANT = 4;
/// @dev Sort Merge Join variant constant for proof plans
uint32 constant SORT_MERGE_JOIN_EXEC_VARIANT = 5;
/// @dev Filter variant constant for proof plans
uint32 constant FILTER_EXEC_VARIANT = 6;
/// @dev Aggregate variant constant for proof plans
uint32 constant AGGREGATE_EXEC_VARIANT = 7;
