...
library FoldUtil {
    ...
    VerificationBuilder.Builder memory __builder, uint256 __columnCount, uint256 __beta)
        external
        pure
        returns (VerificationBuilder.Builder memory __builderOut, uint256 __fold, uint256[] memory __evaluations)
    {
        assembly {
            ...
            __fold, __evaluationsPtr := fold_final_round_mles(__builder, __columnCount, __beta)
